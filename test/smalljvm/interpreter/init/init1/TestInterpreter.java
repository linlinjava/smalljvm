...
public class TestInterpreter {
    public static void main(String[] args) throws java.io.IOException {
        ...
        smalljvm.interpreter.init.init1.Demo.main(new String[0]);
        System.out.println("Hotspot JVM result_byte: " + smalljvm.interpreter.init.init1.Demo.result.m_int);
        System.out.println("Hotspot JVM result_char: " + smalljvm.interpreter.init.init1.Demo.result.m_float);
        System.out.println("Hotspot JVM result_short: " + smalljvm.interpreter.init.init1.Demo.result.m_double);
    }
}
