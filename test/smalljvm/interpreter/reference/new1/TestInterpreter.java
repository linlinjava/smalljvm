package smalljvm.interpreter.reference.new1;
...
public class TestInterpreter {
    public static void main(String[] args) throws java.io.IOException {
        ...
        smalljvm.interpreter.reference.new1.Demo.main(new String[0]);
        System.out.println("Hotspot JVM result_int: " + smalljvm.interpreter.reference.new1.Demo.result.m_int);
        System.out.println("Hotspot JVM result_float: " + smalljvm.interpreter.reference.new1.Demo.result.m_float);
        System.out.println("Hotspot JVM result_double: " + smalljvm.interpreter.reference.new1.Demo.result.m_double);
    }
}
